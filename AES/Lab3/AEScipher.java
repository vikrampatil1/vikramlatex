...
/**
 * This method takes Plaintext and Key strings to perform 10 Rounds of AES
 * Calls various functions in loop.
 * Returns Ciphertext i.e. encrypted text
 * @param text
 * @param key
 * @return 
 */
...
/**
 * This method is the first function of starting AES encryption.
 * Takes two String inputs and calls XOR function on them
 * Returns a 4x4 String matrix
 * @param pTextHex
 * @param keyHex
 * @return 
 */
...
/**
 * This method takes a string matrix and performs substitution using SBOX.
...
/**
 * This method performs the Shifting of Matrix elements. 
 * Takes input as the output of aesNibbleSub() method
 * @param inStateHex
 * @return 
 */
...
/*
 * This method performs mixing of columns using Galois matrix
 * Takes output of aesShiftRow() method as input and returns a 4x4 matrix
 * @param inStateHex
 * @return 
...
for(int i=0;i<4;i++)   
for(int j=0;j<4;j++)
   output[i][j] = Integer.toString(out[i][j]);
...
*/
/**
 * This method takes a 32 bit string input (key) and Generates 11 Round keys for AES rounds
 * returns a 4x44 matrix
 * @param input
 * @return 
 */
...
/**
 * This method is responsible for XORing
 * @param one
 * @param two
 * @return 
 */
